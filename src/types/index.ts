...
export const NFL_DRAFT_ORDER: DraftSlot[] = [
  { pick_number: 1,  round: 1, team: 'Tennessee Titans',       team_abbr: 'TEN' },
  { pick_number: 2,  round: 1, team: 'Cleveland Browns',       team_abbr: 'CLE' },
  { pick_number: 3,  round: 1, team: 'New York Giants',        team_abbr: 'NYG' },
  { pick_number: 4,  round: 1, team: 'New England Patriots',   team_abbr: 'NE'  },
  { pick_number: 5,  round: 1, team: 'Jacksonville Jaguars',   team_abbr: 'JAX' },
  { pick_number: 6,  round: 1, team: 'Las Vegas Raiders',      team_abbr: 'LV'  },
  { pick_number: 7,  round: 1, team: 'New York Jets',          team_abbr: 'NYJ' },
  { pick_number: 8,  round: 1, team: 'Carolina Panthers',      team_abbr: 'CAR' },
  { pick_number: 9,  round: 1, team: 'New Orleans Saints',     team_abbr: 'NO'  },
  { pick_number: 10, round: 1, team: 'Chicago Bears',          team_abbr: 'CHI' },
  { pick_number: 11, round: 1, team: 'San Francisco 49ers',    team_abbr: 'SF'  },
  { pick_number: 12, round: 1, team: 'Dallas Cowboys',         team_abbr: 'DAL' },
  { pick_number: 13, round: 1, team: 'Miami Dolphins',         team_abbr: 'MIA' },
  { pick_number: 14, round: 1, team: 'Indianapolis Colts',     team_abbr: 'IND' },
  { pick_number: 15, round: 1, team: 'Atlanta Falcons',        team_abbr: 'ATL' },
  { pick_number: 16, round: 1, team: 'Arizona Cardinals',      team_abbr: 'ARI' },
  { pick_number: 17, round: 1, team: 'Cincinnati Bengals',     team_abbr: 'CIN' },
  { pick_number: 18, round: 1, team: 'Seattle Seahawks',       team_abbr: 'SEA' },
  { pick_number: 19, round: 1, team: 'Tampa Bay Buccaneers',   team_abbr: 'TB'  },
  { pick_number: 20, round: 1, team: 'Denver Broncos',         team_abbr: 'DEN' },
  ...
  { pick_number: 23, round: 1, team: 'Green Bay Packers',      team_abbr: 'GB'  },
  { pick_number: 24, round: 1, team: 'Minnesota Vikings',      team_abbr: 'MIN' },
  { pick_number: 25, round: 1, team: 'Houston Texans',         team_abbr: 'HOU' },
  { pick_number: 26, round: 1, team: 'Los Angeles Rams',       team_abbr: 'LAR' },
  { pick_number: 27, round: 1, team: 'Baltimore Ravens',       team_abbr: 'BAL' },
  { pick_number: 28, round: 1, team: 'Detroit Lions',          team_abbr: 'DET' },
  { pick_number: 29, round: 1, team: 'Washington Commanders',  team_abbr: 'WAS' },
  { pick_number: 30, round: 1, team: 'Buffalo Bills',          team_abbr: 'BUF' },
  { pick_number: 31, round: 1, team: 'Kansas City Chiefs',     team_abbr: 'KC'  },
  { pick_number: 32, round: 1, team: 'Philadelphia Eagles',    team_abbr: 'PHI' },
];
